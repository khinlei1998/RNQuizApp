...
const HomeScreen = () => {
  ...
  const [categoryData, setCategoryData] = useState<CategoryProps[]>(categories);
      ...
      <View style={styles.container}>
        <SafeAreaView>
          <View style={styles.profileContainer}>
            <Image
              source={{
                uri: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSTYnuvAw7_Vgyirya4Od0qjbZjASZKijOh_g&usqp=CAU',
              }}
